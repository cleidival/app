...
<html lang="en">
  <head>
    ...
    <![endif]-->
<style>
body{background: #ff4500; color: #0000ff;}
.logomarca{display: block; width: 300px; height: 100px; border: 1px solid #ff4500; solid #fff; margin: 0px auto; position: relative;}
.logomarca small{position: absolute; left: 10px; font-style: italic; font-family: Georgia; font-weight: bold; color: #00f; font-size: 18pt;}
.logomarca h1{font-style: italic; font-family: Georgia; font-weight: bold; color: #00f; font-size: 38pt;}
...
<div class="foteer">
	...
	$(document).ready(function() {
  		...
  		$( "#codigoProduto" ).focus();
		setInterval(function(){ $("#resListaProdutos").html(''); }, 10000);	
	});
    </script>
