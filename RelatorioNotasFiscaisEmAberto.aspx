<%@ Page language="c#" Inherits="Nico" CodeFile="RelatorioNotasFiscaisEmAberto.aspx.cs" %>
...
<html lang="en">
  <head>
    ...
    <title>CF SISTEMAS - NOTAS FISCAIS	</title>
  ...
  <body>
    ...
    <div class="container-fluid">
      ...
      <div class="row-fluid">
        <h3>Relatorio Notas Fiscais Em Aberto</h3>
		<div class="well"> 		
			<div class="row">
				...
				<div class='col-sm-6 col-md-6 col-lg-6 col-xl-6'>          
					<p>Data Inicial:<input class="form-control" id="data_inicial" data-date-format="mm/dd/yyyy" value="<%=DateTime.Now.ToString("dd/MM/yyyy")%>"></p>
					<p>Data Final:<input class="form-control" id="data_final" data-date-format="mm/dd/yyyy" value="<%=DateTime.Now.ToString("dd/MM/yyyy")%>"></p>
					<button class="btn btn-primary" id="btnImprimir">Imprimir</button>
				</div>
			</div>
			
			  <div class="row	" id="resultadoRelatorioNotasFiscaisEmAberto" >
    ...
    <script type="text/javascript">
      $(document).ready(function(){        
        ...
        $("#btnImprimir").click(function(){
            ...
            $.ajax({
                url: "processa.aspx",
                data: {"Pagina":"Relatorios","Acao":"NotasFiscaisEmAberto", "filial": filial, "data_inicial": data_inicial, "data_final": data_final},
                beforeSend:function(){
                   $("#resultadoRelatorioNotasFiscaisEmAberto").html("<div class='msgProcessando'>Aguarde enquanto processamos sua solicitacao...<span class='spanTimer'></span></div>");       
                    $(".msgProcessando").show();  
                },
                success:function(data){
                  $("#resultadoRelatorioNotasFiscaisEmAberto").html(data);
