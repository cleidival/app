...
<html lang="en">
  <head>
    ...
    <style type="text/css">
      ...
      .detalhes{font-family: "courier new";}
			...
			<div class="row"> 
				<div class="col-md-2"> 
				  ...
				  <div class="input-group">     
					...
					<p>Data Inicial:<input class="form-control" id="data_inicial" data-date-format="mm/dd/yyyy" value="01/09/2017"></p>
					<p>Data Final:<input class="form-control" id="data_final" data-date-format="mm/dd/yyyy" value="01/09/2017"></p>
